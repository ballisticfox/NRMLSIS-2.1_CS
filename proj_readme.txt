...
INITIALIZING AND RUNNING THE MODEL
  - The model must be initialized using the Initialization subroutine, which sets
    switches and options and loads the model parameter values from a file.
  - The switch_legacy optional argument to Initialization performs the same function
    ...
    follows, where SW is the 25-element array of switches:
        ...
        NRLMSIS 2.1: call Initialization(switch_legacy=SW)
  ...
  - Details of the input and output arguments of Initialization, GTD8D, and MSISCALC
